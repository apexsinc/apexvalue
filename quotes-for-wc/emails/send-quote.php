 ...
 * Send Quote Email
 *
 * APEX VALUE OVERRIDE (v1.11.9): identical to the quotes-for-woocommerce
 * plugin template except the per-item Price column header is removed —
 * the line-subtotal cells are already suppressed by the theme's
 * email-order-items.php override for quote orders, and the totals table
 * below is emptied by the woocommerce_get_order_item_totals filter.
 * If the plugin template changes upstream, re-diff this file after
 * plugin updates.
 *
