<?php
/**
 * Request New Quote email (admin).
 *
 * APEX VALUE OVERRIDE: identical to the quotes-for-woocommerce plugin
 * template except the per-item Price column and line subtotal cells are
 * removed — quotation requests must not expose pricing. If the plugin
 * template changes upstream, re-diff this file after plugin updates.
 *
