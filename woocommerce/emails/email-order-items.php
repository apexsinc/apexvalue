...
/**
 * APEX VALUE OVERRIDE (v1.11.7): hide the per-line price cell for quote
 * orders (site never exposes pricing; see email-order-details.php).
 */
...
foreach ( $items as $item_id => $item ) :
	...
	<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_order_item_class', 'order_item', $item, $order ) ); ?>">
		...
		<td class="td font-family text-align-<?php esc_attr( $price_text_align ); ?>" style="vertical-align:middle;">
	...
	if ( $show_purchase_note && $purchase_note ) {
		?>
		<tr>
			<td colspan="<?php echo $is_apex_quote_order ? 2 : 3; ?>" class="font-family text-align-left" style="vertical-align:middle;">
				<?php
